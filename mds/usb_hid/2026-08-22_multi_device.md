...
## 次にやること
1. ~~修正版で再度実機テスト(キーボード直結 + Hub(マウス+キーボード)の組み合わせ)~~ → 実機確認済み、その後さらにConsumer Control対応(`mds/usb_hid/2026-08-22_consumer_control.md`)まで実装
...
[mds/usb_hid/2026-08-22_9buttons_mouse.md](mds/usb_hid/2026-08-22_9buttons_mouse.md)
